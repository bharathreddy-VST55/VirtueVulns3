...
export const Debug: FC = () => {
  ...
  const fakeEnvVars = [
    ...
    { key: 'API_SECRET_KEY', value: 'sk_live_PLACEHOLDER_REPLACE_IN_PROD' },
    ...
    { key: 'STRIPE_SECRET_KEY', value: 'sk_live_PLACEHOLDER_REPLACE_IN_PROD' },
    { key: 'GITHUB_TOKEN', value: 'ghp_1234567890abcdefghijklmnopqrstuvwxyz' },
    { key: 'SLACK_WEBHOOK_URL', value: 'https://hooks.slack.com/services/PLACEHOLDER_REPLACE_IN_PROD' },
  ];
